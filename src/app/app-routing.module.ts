...
const routes: Routes = [
  ...
  { path: 'afiliacion-show', component: AfiliacionShow2Component, pathMatch: 'full' },
  { path: 'tramite-excepcional-show', component: TramiteExcepcionalShow2Component, pathMatch: 'full' },
