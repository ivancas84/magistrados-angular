...
import { FieldYesNoOptions, TypeLabelOptions, FieldInputSelectCheckboxOptions, FieldInputCheckboxOptions, FieldInputSelectParamOptions, FieldInputAutocompleteOptions, FieldInputSelectOptions, FieldInputTextOptions, FieldDateOptions, FieldInputDateOptions, FieldInputYearMonthOptions, FieldControlOptions } from '@class/field-type-options';
...
@Component({
  selector: 'app-afiliacion-show2',
  templateUrl: '../../core/component/show/show-dynamic.component.html',
})
export class AfiliacionShow2Component extends ShowRelDynamicComponent {
